...
| ElasticNet | L1 + L2             | alpha=0.1, l1\_ratio=0.5 |0.75|35.00| 5.91 |     Balanced trade-off        |
...
\- P2\_Model\_Comparison.ipynb (Main Summary)

\- P2\_Linear\_Regression.ipynb

\- P2\_Lasso\_Regression.ipynb

\- P2\_Ridge\_Regression.ipynb

\- P2\_ElasticNet\_Regression.ipynb
